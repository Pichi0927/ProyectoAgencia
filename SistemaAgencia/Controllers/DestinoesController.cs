...
namespace SistemaAgencia.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public DestinoesController(AgenciaDbContext context)
        {
            _context = context;
        }
        ...
        {
            var agenciaDbContext = _context.Destino.Include(d => d.Pais);
        ...
        public async Task<IActionResult> Create([Bind("DestinoID,Nombre,PaisID")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinoID,Nombre,PaisID")] Destino destino)
        {
